...
const Main = props => {
    ...
    if (page === 'home') {
        ...
        return (
            <main className={`main main__graphics color-1}`}>
                graphics
            </main>
        )
    } else if (page === 'web') {
        return (
            <main className={`main main__web color-3`}>
                web
            </main>
        )
    } else if (page === 'contact') {
        return (
            <main className={`main main__contact color-4`}>
                contact
            </main>
        )
    } else {
        return (
            <main className={`main main__not-found color-2`}>
                404
            </main>
        )
    }
