...
const NavLinks = props => {
    ...
    return (
        <ul className='nav-links'>
            ...
            <li>
                <button onClick={() => props.handleNav('services')} className={`nav-link btn color-1 ${page === 'services' && 'nav-link--active'}`}><span>services</span></button>
            </li>
            <li>
                <button onClick={() => props.handleNav('about')} className={`nav-link btn color-3 ${page === 'about' && 'nav-link--active'}`}><span>about</span></button>
            </li>
            <li>
